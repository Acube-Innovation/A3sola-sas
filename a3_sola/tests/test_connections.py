...
OURS = {
	...
	"Installation Task", "Material Dispatch Notice", "Document Pack", "Customer Review", "Solar Contractor",
	"Portal Application", "Statutory Fee Payment", "Solar Agreement", "Subsidy Claim",
...
class TestConnectionPanels(FrappeTestCase):
	...
	def test_the_chain_runs_from_the_lead_to_service(self):
		...
		for parent, child in (
			...
			("Solar Installation", "Solar Agreement"),
			("Solar Installation", "Installation Task"),
			("Solar Installation", "Document Pack"),
			("Solar Installation", "Material Dispatch Notice"),
			("Solar Installation", "Customer Review"),
			("Solar Contractor", "Material Dispatch Notice"),
